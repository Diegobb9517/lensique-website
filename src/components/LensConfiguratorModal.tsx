    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <iframe 
            src={`/asesor_zeiss.html?v=1.0.4&framePrice=${product?.price_incl_tax || product?.price || 0}&modelName=${encodeURIComponent(product?.name || '')}&brand=${encodeURIComponent(product?.brand || '')}`}
